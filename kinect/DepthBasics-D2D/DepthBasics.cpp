    ...
    if (m_pDepthRGBX && pBuffer && (nWidth == cDepthWidth) && (nHeight == cDepthHeight))
    {
        ...
        while (pBuffer < pBufferEnd)
        {
           ...
           // print('%d', nMinDepth);
            ...
            BYTE x11 = static_cast<BYTE>((depth >= nMinDepth) && (depth <= nMaxDepth) ? (depth >> 8) : 0);
            
            /////////////////////////////////////////////////////////////////////////////////////
          ////  unsigned char  K11 = x11 >> 8;
        ...
        if (1==1)
        {
            ...
            WCHAR szScreenshotPath_1 [] = L"C:\\Users\\aliar\\OneDrive\\Desktop\\kinect\\DepthBasics-D2D\\output_image\\img.png";
            // Write out the bitmap to disk
            HRESULT hr = SaveBitmapToFile(reinterpret_cast<BYTE*>(m_pDepthRGBX), nWidth, nHeight, sizeof(RGBQUAD) * 8, szScreenshotPath_1);
